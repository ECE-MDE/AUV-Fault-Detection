...
// Clients:     None
//
// Publishers:  /setpoint/roll (avl_control/LineSetpointMsg)
//              /setpoint/pitch (avl_control/OrbitSetpointMsg)
//              /setpoint/yaw (avl_control/Float64SetpointMsg)
//              /setpoint/ground_speed (avl_control/Float64SetpointMsg)
//              /setpoint/water_speed (avl_control/Float64SetpointMsg)
//              /setpoint/rpm (avl_control/Float64SetpointMsg)
//              /setpoint/depth (avl_control/Float64SetpointMsg)
//              /setpoint/height (avl_control/Float64SetpointMsg)
//
// Subscribers: None
//==============================================================================
...
private:
    ...
    void init()
    {
        ...
        pub_map["FRONT RUDDER"]       = {node_handle->advertise<Float64SetpointMsg>("/setpoint/front_rudder", 1),   true};
        pub_map["FRONT ELEVATOR"]     = {node_handle->advertise<Float64SetpointMsg>("/setpoint/front_elevator", 1), true};
    }

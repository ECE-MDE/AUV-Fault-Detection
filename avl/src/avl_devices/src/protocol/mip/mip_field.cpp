...
//------------------------------------------------------------------------------
MipField::MipField() : MipField(0x00, {})
{
...
//------------------------------------------------------------------------------
MipField::MipField(uint8_t field_descriptor)
{
...
//------------------------------------------------------------------------------
MipField::MipField(uint8_t field_descriptor, std::vector<uint8_t> field_data)
{
...
//              - field_data: field data bytes
//------------------------------------------------------------------------------
MipField::MipField(std::vector<uint8_t> field_bytes)
{
...
//------------------------------------------------------------------------------
std::vector<uint8_t> MipField::get_bytes()
{
...
//------------------------------------------------------------------------------
void MipField::set_bytes(std::vector<uint8_t> field_bytes)
{
...
//------------------------------------------------------------------------------
uint8_t MipField::get_descriptor()
{
    return descriptor;
}
...
// Arguments:   - field_descriptor: field descriptor byte
//------------------------------------------------------------------------------
void MipField::set_descriptor(uint8_t field_descriptor)
{
    descriptor = field_descriptor;
}
...
//------------------------------------------------------------------------------
std::vector<uint8_t> MipField::get_data()
{
    return data;
}
...
//------------------------------------------------------------------------------
void MipField::set_data(std::vector<uint8_t> field_data)
{
...
//------------------------------------------------------------------------------
std::string MipField::get_string()
{
...
//------------------------------------------------------------------------------
void MipField::validate_bytes(std::vector<uint8_t> bytes)
{
    ...
    {
        throw std::runtime_error("failed to parse improperly formatted MIP field bytes (length does not match)");
    }

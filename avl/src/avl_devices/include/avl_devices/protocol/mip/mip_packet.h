...
// Packet header bytes
const std::vector<uint8_t> MIP_PACKET_HEADER = {0x75, 0x65};
...
public:
    ...
    //--------------------------------------------------------------------------
    static std::vector<MipPacket> parse_multiple(std::vector<uint8_t> bytes);
...
public:
    ...
    //--------------------------------------------------------------------------
    MipPacket(std::vector<uint8_t> packet_bytes);
    ...
    // Returns:     field.
    //--------------------------------------------------------------------------
    MipField get_field(uint8_t field_descriptor);
...
private:
    ...
    // Packet header bytes
    std::vector<uint8_t> header = MIP_PACKET_HEADER;
